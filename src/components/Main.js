      ...
      <div ref={this.props.setWrapperRef} id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="intro" className={`${this.props.article === 'intro' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <span className="image main"><img src={masen} alt="Masen Matthews" /></span>
            <p>I'm a software developer based in Portland, Oregon. My background includes experience working with technologies like HTML, CSS, Python, JavaScript, React, React Native, Angular, Ruby, and Ruby on Rails. I also have experience with Git, SQL, Flask, automated testing, and a variety of other tools. I am constantly adding to this list and love embracing opportunities to learn about new languages, libraries, and development tools. </p>

            <p>My immediate goals are centered around finding a position in tech that allows me to learn, grow, and work alongside a team of great people. I'm quick to embrace challenges and I find gratification in diving into the unknown. If you're interested in checking out my latest coding endeavors, feel free to take a look at my <a href="https://github.com/masenmatthews" target="_">GitHub</a> or the "work" section of this site.</p>

            <p>A large part of my passion for software development lies in the realm of accessibility. As a visually impaired developer with a background in sociology, I want to make the web a more welcoming place for people with disabilities by advocating for diversity, inclusion, and accessible development practices. Outside of that, I'm passionate about exploring various aspects of frontend and backend development and using technology as a means to facilitate continuous learning and mentorship.</p>

            <p>Building community inside and outside of the tech world is important to me as well. One of my ongoing accomplishments has involved starting and operating a community organization called Portland Future Leaders In Tech (pdxFLIT). We host monthly events and operate as a welcoming, safe space for new developers and tech affiliates while providing mentorship and education opportunities. You can learn more about pdxFLIT <a href="https://www.meetup.com/pdxFLIT-Portland-Future-Leaders-In-Tech/" target="_">here!</a></p>

            <p>My hobbies and interests outside of technology include activities related to food, coffee, music, yoga, and fitness in general. I'm a regular patron of Portland's music scene and can often be found squeezing vinyasa sessions into my schedule whenever I have the chance.</p>
          {close}
        </article>
